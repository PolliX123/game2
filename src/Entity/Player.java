...
public class Player extends MapObject {
	...
	public Player(TileMap tm) {
		...
		//new
		playerName = "";
        nameFont = new Font("Arial", Font.PLAIN, 10); // Adjust font properties
	}
	...
	public void draw(Graphics2D g) {
		// Draw player's name above the character
        g.setFont(nameFont);
        g.setColor(Color.WHITE);
        int nameOffsetY = -10; // Adjust the vertical position of the name
        g.drawString(playerName, (int) (x + xmap - playerName.length() * 2), (int) (y + ymap + nameOffsetY));
		setMapPosition();
